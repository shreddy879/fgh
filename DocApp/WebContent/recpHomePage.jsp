...
<div id="demo-1" class="banner-inner">
				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav linkEffects linkHoverEffect_12">
							...
							<li><a class="active" href="recpLogin.jsp"><span>Logout</span></a></li> 
	...
	<center>
		<h2>Choose a task to perform</h2><br><br>
		<ul class="nav navbar-nav linkEffects linkHoverEffect_12">
			<li><a href="Book.jsp"><span>Book an Appointment</span></a></li>
			<li><a href="alter.jsp"><span>Alter the Appointment</span></a></li> 
