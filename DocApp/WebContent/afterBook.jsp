				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
						<ul class="nav navbar-nav linkEffects linkHoverEffect_12">
							...
							<li><a class="active" href="recpLogout.html"><span>Logout</span></a></li>
...
<center>
	<br><br><br><h1>Booking successfully done!</h1><br><br><br>
	<a class="active" href="recpHomePage.jsp">Book Another Appointment</a> &nbsp; | &nbsp;
	<a class="active" href="recpLogout.html">Logout</a>
